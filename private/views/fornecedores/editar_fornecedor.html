    ...
    <div class="layout-privado">
        ...
        <main class="conteudo-privado">
            ...
            <section class="formulario-privado">
                ...
                <form id="form-editar-fornecedor" class="form-editar-equipamento-privado">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select campo-formulario-privado" id="morada" name="morada">
                                <option value="" disabled>Escolha uma morada</option>
                    ...
                    <div class="botoes-formulario-privado">
                        <a href="fornecedores.html" id="botao-cancelar-edicao-fornecedor"
